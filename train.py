...
from model.region_loss import RegionLoss
from model.darknet import Darknet
# from MeshPly import MeshPly
# import open3d as _3d
import cfg.data_config as data_config
...
if __name__ == "__main__":
    ...
    parser.add_argument('--datacfg', type=str, default='cfg/beer.data') # data config
    ...
    summary = SummaryWriter('log/beer')
    ...
    # bg_file_names = get_all_files('/mnt/lustrenew/yangyang14/singleshotpose-master-running/VOCdevkit/VOC2012/JPEGImages')
    bg_file_names = get_all_files('F:\singleshotpose-master-running\VOCdevkit\VOC2012\JPEGImages')
    ...
    corners              = data_config.box_6d().beer[1:,:]  # 8x3
