...
if __name__ == "__main__":
    ...
    parser.add_argument('--datacfg', type=str, default='cfg/car.data') # data config
    ...
    corners              = data_config.box_6d().red_cylinder_own_center[1:,:]  # 8x3
    corners3D            = np.concatenate((np.transpose(corners), np.ones((1,8)) ), axis=0) # 4x8
