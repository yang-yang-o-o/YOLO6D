...
if __name__ == "__main__":
    ...
    # parser.add_argument('--datacfg', type=str, default='cfg/red_cylinder.data') # data config
    parser.add_argument('--datacfg', type=str, default=f'cfg/{obj_name}.data') # data config
    ...
    summary = SummaryWriter(f'log/{obj_name}')
    ...
    corners              = data_config.box_6d().crest[1:,:]  # 8x3
