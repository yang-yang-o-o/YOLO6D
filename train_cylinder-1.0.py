...
if __name__ == "__main__":
    ...
    parser.add_argument('--datacfg', type=str, default='cfg/cylinder-1.0.data') # data config
    ...
    summary = SummaryWriter('log/cylinder-1.0')
    ...
    corners              = data_config.box_6d().red_cylinder[1:,:]  # 8x3
