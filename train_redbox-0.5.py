...
if __name__ == "__main__":
    ...
    parser.add_argument('--datacfg', type=str, default='cfg/redbox-0.5.data') # data config
    ...
    summary = SummaryWriter('log/redbox-0.5')
    ...
    corners              = data_config.box_6d().redbox[1:,:]  # 8x3
